...
import com.jsmvp.microservices.jobSearchservice.Job;
import com.jsmvp.microservices.jobSearchservice.JobSearchResults;
...
public class jobSearchController {
    ...
    @GetMapping("/t1")
    public void getJobSearchResultsViaKeywords() {
...
//        String result = restTemplate.getForObject(kurl+ keywords.trim(), String.class);
        ...
        ResponseEntity<Job> result = restTemplate.exchange(kurl.toString(), HttpMethod.GET, entity, Job.class);

        Job job = result.getBody();
    ...
    @GetMapping("/t2")
    public void getJobSearchResultsViaKeywords2() {
        RestTemplate restTemplate = new RestTemplate();
//        String result = restTemplate.getForObject(kurl+ keywords.trim(), String.class);
        ...
        try {
            String jres = objectMapper.writeValueAsString(job);
    ...
    @GetMapping("/t3")
    public void getJobSearchResultsViaKeywords3() {
        RestTemplate restTemplate = new RestTemplate();
//        String result = restTemplate.getForObject(kurl+ keywords.trim(), String.class);
        ...
        try {
            String jres = objectMapper.writeValueAsString(result);
